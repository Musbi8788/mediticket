                    ...
                    {activeTab === "chat" ? (
                      ...
                      <div className="flex-1 overflow-y-auto px-5 py-4 flex flex-col gap-3">
                        {[
                          ...
                          { label: "Phone", value: selected.patientPhone ?? "—" },
                          { label: "Address", value: selected.patientAddress ?? "—" },
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="bg-white rounded-2xl shadow-sm p-5">
                    ...
                    <p className="text-xs text-gray-500 leading-relaxed mb-4">
                      Open WhatsApp to contact the patient directly before or after their consultation.
                    </p>
                    {selected.patientPhone ? (
                      <a
                        href={`https://wa.me/${selected.patientPhone.replace(/\D/g, "")}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full h-10 rounded-xl bg-[#25D366] text-white text-sm font-bold hover:bg-[#1ebe5d] transition-colors flex items-center justify-center gap-2"
                      >
                      ...
                      <div className="w-full h-10 rounded-xl bg-gray-100 text-gray-400 text-sm font-semibold flex items-center justify-center">
